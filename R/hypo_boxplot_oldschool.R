...
png("../figs/manyboxplots_oldschool.png", width=1000, height=600, pointsize=18, bg="black")
par(bg="black", fg="white", col="white", col.axis="white", col.lab="white", mar=c(4.1, 3.6, 1.1, 1.1))
...
png("../figs/manyboxplots_oldschoolB.png", width=1000, height=600, pointsize=18, bg="black")
par(bg="black", fg="white", col="white", col.axis="white", col.lab="white", mar=c(4.1, 3.6, 1.1, 1.1))
boxplot(hypo.mlratio, las=1, cex=0.5, names=rep("", n.arrays), outcol="darkslateblue")
axis(side=1, at=seq(100, n.arrays, by=100), tick=FALSE, mgp=c(1.8, 0.8, 0))
title(xlab="Arrays, sorted by median expression", mgp=c(1.8, 0.35, 0))
title(ylab="Gene expression", mgp=c(1.8, 0.35, 0))
dev.off()
