...
(function() {
  ...
  draw = function(data) {
    var Zscale, altpink, axislabels, bigRad, bottom, c, checkerboard, checkerboard2, chrGap, chrLowXScale, chrXScale, chrYScale, chrindex, ci, cj, cur, curXPixel, curYPixel, darkGray, darkblue, darkgreen, darkred, draw_probe, efftip, eqtltip, fasttime, g, h, i, i1, indtip, j, jitter, jitterAmount, k, l, labelcolor, left, len, len1, len10, len2, len3, len4, len5, len6, len7, len8, len9, lightGray, m, maincolor, martip, maxlod, newg, nodig, o, onedig, p, pad, peakRad, peaks, pink, purple, pxgXscaleA, pxgXscaleX, q, r, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, results, right, s, slowtime, svg, t, tickHeight, titlecolor, top, totalChrLength, totalh, totalw, twodig, u, v, w, xloc, y, yloc;
...
// gray backgrounds
    ...
    draw_probe = function(probe_data) {
      var chr, curves, draw_pxgXaxis, ensembl, gene, i1, j1, k1, lastMarker, len10, len11, len12, lod, lodcurve, lodcurve_yScale, markerClick, maxlod_marker, meanmarks, mgi, plotPXG, pos, probeaxes, pxgXaxis, pxgYaxis, pxgYscale, ref10, ref11, ref12, revPXG, ticks, title, titletext, xlink, yaxis;
      ...
      ref11 = data.chrnames;
      for (j1 = 0, len11 = ref11.length; j1 < len11; j1++) {
        c = ref11[j1];
      ...
      markerClick = {};
      ref12 = data.markers;
      for (k1 = 0, len12 = ref12.length; k1 < len12; k1++) {
        m = ref12[k1];
        markerClick[m] = 0;
      }
      lastMarker = "";
    ...
    chrindex = {};
    ref10 = data.chrnames;
    for (i = i1 = 0, len10 = ref10.length; i1 < len10; i = ++i1) {
      c = ref10[i];
      chrindex[c] = i;
    }
